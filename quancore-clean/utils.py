    ...
    def next_batch(self):
        ...
        while i < self.batch_size:
            ...
            if idx + self.seq_length-1 < len(frame_data):
                ...
                print(np.shape(self.target_ids))
                print("TARGET_IDS[self.dataset_pointer)")
                print(self.target_ids[self.dataset_pointer])
                print("DATASET_POINTER")
                print(self.dataset_pointer)
                print("FRAME_POINTER")
                print(self.frame_pointer)
                print("SEQ_LENGTH")
