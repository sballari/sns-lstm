...
def main():
    if (__name__=="__main__"):
    	...
    	# RNN size parameter (dimension of the output/hidden state)
        parser.add_argument('--rnn_size', type=int, default=hparams.rnnSize, help='size of RNN hidden state')
        ...
        parser.add_argument('--neighborhood_size', type=int, default=hparams.neighborhoodSize,
        ...
        parser.add_argument('--grid_size', type=int, default=hparams.gridSize,
